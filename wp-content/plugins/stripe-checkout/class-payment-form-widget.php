...
class Custom_3d_payment_form_Widget extends Widget_Base
{
    ...
    protected function render(){
        ...
        foreach($fields as $field){
            ...
            if($field_type == 'text'){
               $html .= "<input id='$field_id' name='$field_id' type='text' placeholder='$field_placeholder' required='$field_required' class='$custom_css_class'>";
            } elseif($field_type == 'select'){
               $select_options = isset($field['select_options']) ? sanitize_textarea_field($field['select_options']) : '';
               $select_options = explode("\n",$select_options);  
               //var_dump($select_options);
               $html .= "<select id='$field_id' name='$field_id' required='$field_required' class='$custom_css_class'>";
               ...
               $html .= "<div id='$field_id' class='$custom_css_class $field_id'></div>";  
                ...
                $html .= "<input id='$field_id' name='$field_id' type='$field_type' placeholder='$field_placeholder' required='$field_required' class='$custom_css_class'>";                 
            } elseif($field_type == 'tel') {
                $html .= "<input id='$field_id' name='$field_id' type='$field_type' placeholder='$field_placeholder' required='$field_required' class='$custom_css_class'>";
            } elseif($field_type == 'hidden') {
                $html .= "<input id='$field_id' name='$field_id' type='hidden'>";   
            } elseif($field_type == 'coupon') { 
                $html .= "<input id='$field_type' name='$field_type' required='$field_required' placeholder='$field_placeholder' value='' class='$custom_css_class'>"; 
                ...
                $html .= "<select id='$field_type' name='$field_type' required='$field_required' class='$custom_css_class'>";    
                try {
                ...
                $html .= "</select>"; 
                //$html .= "<input type='hidden' id='price_id' name='price_id' value='$payment_price->id'>";
                $html .= "<input type='hidden' id='page_id'  name='page_id'  value='$page_id' >";
        ...
        $html .= "<button type='submit' id='submit'>לתשלום</button>";
        $html .= "</div>";
